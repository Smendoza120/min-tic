...
public class Principal {
    public static void main(String [] args){
        ...
        do {
            ...
            switch (opcion) {
                case 1: t1.setMoverArriba(incremento); break;
                case 2: t1.setMoverAbajo(incremento); break;
                case 3: t1.setMoverDerecha(incremento); break;
                case 4: t1.setMoverIzquierda(incremento); break;
                case 5: break;
