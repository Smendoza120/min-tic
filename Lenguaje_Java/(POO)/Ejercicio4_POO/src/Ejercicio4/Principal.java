...
public class Principal {
    ...
    public static int indiceGanador(Competencia atletas[]){
        float tiempoCarrera;
        int indice = 0;
    ...
    public static void main(String [] args){
        ...
        String nombre;
        int numeroA, nAtletas, indiceAtletaGanador;
        float tiempoCarrera;
        ...
        Competencia atletas[] = new Competencia[nAtletas];
        ...
        for(int i=0; i<atletas.length;i++){
            ...
            atletas[i] = new Competencia(numeroA, nombre, tiempoCarrera);
        }
